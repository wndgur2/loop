...
스스로 남긴 피드백을 Loopie가 구조화해 **"되돌아보기"를 "목표 달성"으로 연결**하는 모바일 앱.
...
- [documents/loopie-spec.md](documents/loopie-spec.md) — Loopie 스펙 (대화 흐름 · 출력 계약 · 회고)
- [documents/eval-rubric.md](documents/eval-rubric.md) — Loopie 품질 평가 기준
