        ...
        <div style={{ padding: "6px 22px 20px" }}>
          ...
          <div
            ...
            style={{
              ...
              gap: 18,
              alignItems: "center",
              background: "linear-gradient(180deg,#FFFCF9,#FFFFFF)",
            }}
          >
            ...
            <div>
              ...
              >
                <LIcon name="target" size={15} color="var(--loop-warm-deep)" />{" "}
                Toward: Product Owner
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              All{" "}
              <LIcon name="chevron-down" size={15} color="var(--loop-ink-4)" />
            </span>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {FEEDBACK.slice(0, 3).map((f) => (
              <div
                key={f.id}
                className="lp-card"
                style={{ padding: "16px 17px", borderRadius: 18 }}
              >
                <div
                  style={{
                    display: "flex",
                ...
                <div
                  style={{
                    display: "flex",
                    alignItems: "center",
                    borderTop: "1px solid var(--loop-line-soft)",
                    paddingTop: 11,
                  }}
                >
                  {f.internalized ? (
                    ...
                    <TakeawayProgress done={f.done} total={f.takeaways} />
                  )}
                  <LIcon
                    name="chevron-right"
                    size={17}
            ...
            <div style={{ flex: 1 }}>
              ...
              <div
                style={{
                  height: 7,
                  borderRadius: 9999,
                  background: "var(--loop-ring-track)",
                  overflow: "hidden",
                }}
              >
                <div
            ...
            >
              <div
                style={{
                  width: 3,
                  borderRadius: 9999,
                  background: impBar[f.importance],
                  flex: "none",
                  marginTop: 2,
                  alignSelf: "stretch",
                }}
  ...
  return (
    <Phone>
      <div
        ...
        style={{ overflow: "hidden", background: "var(--loop-warm-soft)" }}
      >
        <div style={{ padding: "10px 24px 22px" }}>
          ...
          >
            <Ring value={0.62} size={168} stroke={13}>
              ...
              >
                62
                <span style={{ fontSize: 20, color: "var(--loop-ink-4)" }}>
                  %
                </span>
              </span>
              <span className="lp-eyebrow" style={{ marginTop: 4 }}>
                Internalized
              </span>
            </Ring>
            <div
            ...
            >
              You've closed 8 of 13 loops on the way to{" "}
              <span style={{ color: "var(--loop-warm-deep)", fontWeight: 700 }}>
                Product Owner
              </span>
              .
            </div>
        ...
        <div
          style={{
            ...
            boxShadow: "0 -2px 20px rgba(60,50,42,0.05)",
            minHeight: 220,
          }}
        >
          <div
