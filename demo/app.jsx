  ...
  return (
    <Gallery tagline="Self-feedback, closed into a loop. AI structures what you noticed, aligns it to your goal, and brings it back when it matters. Hi-fi screen designs — warm and calm, on the Wanted foundations.">
      <GallerySection
        ...
        <GalleryFrame label="A · Calm cards"><HomeCalm /></GalleryFrame>
        <GalleryFrame label="B · Quiet list (crisp)"><HomeQuiet /></GalleryFrame>
        <GalleryFrame label="C · Warm hero"><HomeHero /></GalleryFrame>
      </GallerySection>
      ...
      <GallerySection
        ...
        <GalleryFrame label="C · Quiet journal"><ChatJournal /></GalleryFrame>
      </GallerySection>

      <GallerySection
        title="Feedback detail"
        subtitle="Canonical template + takeaway tracking · open loop vs closed (internalized)">
        <GalleryFrame label="Open loop"><DetailOpen /></GalleryFrame>
        <GalleryFrame label="Closed loop"><DetailClosed /></GalleryFrame>
      </GallerySection>

      <GallerySection
        title="Retrospective"
        subtitle="App serves up what to revisit · 3 takes on the recommended-cards UX">
        <GalleryFrame label="A · Stacked recommendations"><RetroStacked /></GalleryFrame>
        <GalleryFrame label="B · Single hero + chips"><RetroHero /></GalleryFrame>
        <GalleryFrame label="C · Reflection in progress"><RetroChat /></GalleryFrame>
      </GallerySection>
    </Gallery>
  );
}
