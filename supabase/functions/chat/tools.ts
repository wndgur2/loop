...
const createFeedbackTool = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      situation: {
        type: "string",
        description: "Situation description (## Feedback)",
      },
      root_cause: {
        type: "string",
        description:
          "Root cause derived from the conversation (in the user's words)",
      },
      category: {
        type: "string",
        description: "Name of one of the user's sub-goals (required)",
      },
      importance: { type: "string", enum: ["high", "mid", "low"] },
      tags: {
        type: "array",
        items: { type: "string" },
        description: "1–5 items",
      },
      takeaways: {
        type: "array",
...
const retrospectiveTool = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      internalized: {
        type: "boolean",
        description: "Change the internalized-complete mark (optional)",
      },
      takeaway_updates: {
        type: "array",
        ...
        items: {
          ...
          properties: {
            takeaway_id: {
              type: "string",
              description: "If absent, add as new",
            },
