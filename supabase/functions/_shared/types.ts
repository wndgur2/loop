// 코칭 Edge Function의 요청/응답 계약.
// 정본: documents/ai-coaching-spec.md (§4 출력 스키마 · §9 회고) · evals/runner.ts(CoachingOutput)
...
/** 작성 모드 툴 `피드백 생성`의 산출물 (ai-coaching-spec §4 = Canonical Template) */
...
/** 회고 모드 툴 `회고`의 산출물 (ai-coaching-spec §9) — 변경은 확인 후 커밋 */
...
export type CoachingProposal = FeedbackProposal | RetrospectiveProposal;
